...
export function getInstrumentNameFromId(id: number) {
  return MIDI_INSTRUMENTS[id] ?? MIDI_INSTRUMENTS[0];
}

export function getIdFromInstrumentName(instrumentName: string) {
  return MIDI_INSTRUMENTS.findIndex(i => i === instrumentName) || 0;
}
